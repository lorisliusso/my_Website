...
import Exelio from "../icons/exelio.jpg"
...
// @TODO (CREATE COMPONENT TO REUSE CODE!)
        ...
        <ul className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-12 ">
            ...
            <li>
                ...
                <div className="flex space-x-5">
                    ...
                    <img className="w-10 h-10" src={Exelio} alt="codecademy-logo" />

                    <div className="flex flex-col space-y-5">
                        <h2 className="font-bold">Web Developer</h2>
                        <p className="underline">Exelio S.r.l.</p>
                        <p>Nov 2022 - Presente</p>
                        <p> Development of features for the company's business application using the following technologies: 
                            <strong> ReactJS, Django, GraphQL, TypeScript, SCSS, TailwindCSS, MaterialUI, HTML.</strong></p>
            ...
            <li>
                ...
                <div className="flex space-x-5">
                    ...
                    <div className="flex flex-col space-y-5">
                        ...
                        <p>Specialization course in Ai with prevalent use of Microsoft Azure services, graduated in
                            July. </p>
                ...
                <div className="flex space-x-5">
                    ...
                    <div className="flex flex-col space-y-5">
                        ...
                        <p><span className="font-semibold mr-1">Topics covered:</span>
                            ...
                            [Python, SQL, Statistics, Calculus, Linear Algebra, Pandas, Numpy, Matplotlib, Seaborn,
                            Plotly, Scipy, Sklearn, Tensorflow, Google Cloud Platform, Docker, Fast-api.
                        </p>
                    </div>
